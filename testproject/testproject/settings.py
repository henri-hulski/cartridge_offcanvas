...
# SHOP_PRIMARY_COUNTRIES = [
#     'FR', 'PL', 'DE', 'GB'
# ]
# SHOP_SUPPORTED_COUNTRIES = [
#     'AL', 'AT', 'BA', 'BE', 'BG', 'CH', 'CY', 'DE', 'DK', 'EE', 'ES', 'FI', 'FR', 'GB', 'GR', 'HR',
#     'HU', 'IE', 'IS', 'IT', 'LT', 'LV', 'MK', 'MT', 'NL', 'NO', 'PL', 'PT', 'RO', 'RS', 'SE', 'SI',
# ]
#
# BRAINTREE_MERCHANT_ID = "3b87sstv7s8kghmx"
# BRAINTREE_PUBLIC_KEY = "5qryr8f2mr5qkrqm"
# BRAINTREE_PRIVATE_KEY = "c1a67ea47150aee2e36e2e8fa72e6af9"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "offcanvas_cart.context_processors.off_cart_formset",
            ],
            "builtins": [
